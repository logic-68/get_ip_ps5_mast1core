...
namespace PS
{
    namespace Sce
    {
        ...
        public:
            ...
            static int32_t GetCpumodeGame(int *cpumodegame);
            ...
            static int32_t Sysctlbyname(const char * name, void * oldp, size_t * oldlenp, void * newp, size_t newlen);       

            #endif
        private:
            static uint64_t pGetCpuTemperature;
        };
    }
}
#endif